...
func commandPlan() CommandInfo {
	return legacyDiscoverableCommand("/plan", "[on|off|toggle|status]", "Toggle Plan Mode (investigation -> plan -> approval -> implementation)", "Plan Modeを切り替え", CommandCategoryDev, 120)
}
