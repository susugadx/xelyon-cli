...
func TestGetModelTokenLimit_ExactMatch(t *testing.T) {
	tests := []struct {
		...
		{"jp.anthropic.claude-sonnet-4-6-v1:0", 1000000},
...
func TestGetKnownModelTokenLimit_KnownAndUnknown(t *testing.T) {
	tests := []struct {
		...
		{model: "global.anthropic.claude-opus-4-8", wantLimit: 1000000, wantKnown: true},
		{model: "global.anthropic.claude-sonnet-4-6", wantLimit: 1000000, wantKnown: true},
		{model: "jp.anthropic.claude-sonnet-4-6", wantLimit: 1000000, wantKnown: true},
		{model: "global.anthropic.claude-sonnet-4-6-v1:0", wantLimit: 1000000, wantKnown: true},
