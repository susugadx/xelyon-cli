	...
	return map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"intent": map[string]interface{}{
				"type":        "string",
				"enum":        []string{"impact"},
				"description": "Optional high-level intent. intent=impact prefers a structured Go, TypeScript .ts/.d.ts, targeted TSX .tsx, or JavaScript .js/.jsx single-symbol impact path when available; use file_filter=go, *.go, scoped Go **/*.go globs, or direct .go paths for Go, file_filter=ts, *.ts, *.d.ts, or direct .ts/.d.ts paths for TypeScript, file_filter=tsx, *.tsx, or direct .tsx paths for TSX, and file_filter=js, *.js, direct .js paths, file_filter=jsx, *.jsx, or direct .jsx paths for JavaScript. file_filter=typescript and file_filter=javascript remain broad fallback scopes; .mjs/.cjs are not JavaScript structured impact targets. Otherwise it falls back to a conservative related multi-pattern search. Already comma-separated patterns are used as-is.",
			},
