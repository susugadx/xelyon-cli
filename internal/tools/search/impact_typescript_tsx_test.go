...
func TestExecuteSearchCodeArtifactWithConfig_TSXStructuredImpactRelatedTestsOrder(t *testing.T) {
	dir := setupMultiLangDir(t, map[string]string{
		...
		"src/__tests__/Button.spec.tsx": "import { describe } from 'vitest'\ndescribe('nested component spec', () => {})\n",
		"tests/Button.test.tsx":         "import { describe } from 'vitest'\ndescribe('workspace component', () => {})\n",
		"tests/Button.spec.tsx":         "import { describe } from 'vitest'\ndescribe('workspace component spec', () => {})\n",
	})
	...
	assertSymbolBundleItemsContainFiles(t, tests, []string{
		"src/Button.test.tsx",
		"src/Button.spec.tsx",
