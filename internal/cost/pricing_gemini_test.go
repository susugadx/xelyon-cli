...
func TestGetGeminiPricing_AllModels(t *testing.T) {
	tests := []struct {
		...
		{name: "2.0-flash alias", model: "gemini-2.0-flash-001", ptc: 0, wantInput: 0.10, wantOutput: 0.40, wantStorage: 1.00},
		{name: "2.0-flash-lite no storage", model: "gemini-2.0-flash-lite", ptc: 0, wantInput: 0.075, wantOutput: 0.30, wantStorage: 0},
		{name: "2.0-flash-lite alias no storage", model: "gemini-2.0-flash-lite-001", ptc: 0, wantInput: 0.075, wantOutput: 0.30, wantStorage: 0},
	}
