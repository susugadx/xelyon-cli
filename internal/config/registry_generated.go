...
var SelectOptions = map[string][]string{
	...
	"web_search.provider":                                       {"kimi", "moonshot", "openai", "openai_subscription", "gemini", "claude", "anthropic"},
}
...
var FieldDescriptions = map[string]string{
	...
	"web_search.provider":                              "検索プロバイダー（kimi / moonshot / openai / openai_subscription / gemini / claude / anthropic、未設定時はメインプロバイダーを使用）",
}
