...
var CategoryDefinitions = []CategoryDef{
	...
	{Name: "plan_mode", DisplayName: "Plan Mode", Icon: "📋", Fields: []string{"plan_mode.auto_retry", "plan_mode.max_parallel_steps"}},
...
var FieldDescriptions = map[string]string{
	...
	"plan_mode.auto_retry":             "自動リトライ回数（ツール失敗時にユーザー入力なしで自動リトライ）",
	"plan_mode.max_parallel_steps":     "並列実行する最大ステップ数",
