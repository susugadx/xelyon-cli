...
var CategoryDefinitions = []CategoryDef{
	...
	{Name: "provider_history_reduction", DisplayName: "Provider History Reduction", Icon: "📉", Fields: []string{"provider_history_reduction.mode", "provider_history_reduction.raw_output_artifacts.active_context_budget_max_tokens", "provider_history_reduction.raw_output_artifacts.active_context_budget_tokens", "provider_history_reduction.raw_output_artifacts.chunk_bytes", "provider_history_reduction.raw_output_artifacts.max_artifact_bytes", "provider_history_reduction.raw_output_artifacts.mode", "provider_history_reduction.raw_output_artifacts.retention", "provider_history_reduction.raw_output_artifacts.session_quota_bytes", "provider_history_reduction.rehydrate_context"}},
