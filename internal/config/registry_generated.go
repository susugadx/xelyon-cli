...
var FieldDescriptions = map[string]string{
	...
	"agent_instructions.global.files":               "global guidance ファイル候補",
	...
	"agent_instructions.project.files":              "project-local guidance ファイル候補",
	"agent_instructions.project.include_gitignored": "gitignored / untracked guidance を許可",
	"agent_instructions.project.mode":               "project-local guidance の読み込みモード（off / fallback / always）",
