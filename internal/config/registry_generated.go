...
var CategoryDefinitions = []CategoryDef{
	...
	{Name: "compression", DisplayName: "Compression", Icon: "📦", Fields: []string{"compression.auto_compress", "compression.keep_recent", "compression.model", "compression.prefer_compact_api", "compression.threshold_percent", "compression.threshold_tokens", "compression.token_threshold"}},
