...
var CategoryDefinitions = []CategoryDef{
	...
	{Name: "plan_mode", DisplayName: "Plan Mode", Icon: "📋", Fields: []string{"plan_mode.confirm_level", "plan_mode.heavy_model", "plan_mode.light_model", "plan_mode.max_retry", "plan_mode.max_workers", "plan_mode.parallel", "plan_mode.step_timeout", "plan_mode.supervisor_model"}},
	...
	{Name: "repomap", DisplayName: "RepoMap", Icon: "🗺️", Fields: []string{"repomap.enabled", "repomap.max_tokens"}},
...
var FieldDescriptions = map[string]string{
	...
	"repomap.enabled": "RepoMapを有効化（デフォルト: true）",
