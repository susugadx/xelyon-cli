...
func showAddedFile(out io.Writer, pal uistyle.FileOpPalette, f PatchFileDisplay) {
...
func showDeletedFile(out io.Writer, pal uistyle.FileOpPalette, f PatchFileDisplay) {
...
func showModifiedFile(out io.Writer, pal uistyle.FileOpPalette, f PatchFileDisplay) {
