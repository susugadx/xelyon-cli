...
func (p *OpenAIProvider) chatWithImageCompletions(ctx context.Context, systemPrompt string, history []Message, userMessage string, image *ImageData, model string) (string, error) {
	cfg := config.GetGlobalConfig()
