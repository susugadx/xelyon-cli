...
func setupDeepSeekJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
...
func setupGroqJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
	setCommonDoctorJSONBaselineEnv(t)
...
func setupOllamaJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
	setCommonDoctorJSONBaselineEnv(t)
...
func setupOpenRouterJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
	setCommonDoctorJSONBaselineEnv(t)
...
func setupOpenAIJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
	setCommonDoctorJSONBaselineEnv(t)
...
func setupAzureJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
	setCommonDoctorJSONBaselineEnv(t)
...
func setupKimiJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
...
func setupGeminiJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
...
func setupClaudeJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
...
func setupBedrockJSONBaselineContract(t *testing.T, cmd *doctorTestCommand) doctorJSONBaselineSetupContract {
	t.Helper()
