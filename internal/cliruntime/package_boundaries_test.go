...
var forbiddenImportRules = []architectureImportRule{
	{
		...
		rule:       "internal/cliruntime must not import Cobra; cmd owns flag binding and output streams",
	},
	{
		importRoot: "github.com/susugadx/xelyon-cli/cmd",
		rule:       "internal/cliruntime must not import cmd; runtime selection must stay below command wiring",
	},
	{
		importRoot: "github.com/susugadx/xelyon-cli/internal/app",
		rule:       "internal/cliruntime must not import app; app startup remains a caller concern",
	},
	{
		importRoot: "github.com/susugadx/xelyon-cli/internal/tui",
		rule:       "internal/cliruntime must not import TUI packages",
	},
}

func TestArchitectureBoundaries(t *testing.T) {
	assertNoForbiddenImports(t, "cliruntime", forbiddenImportRules)
}
