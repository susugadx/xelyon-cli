...
- If fetched external_doc snippets contradict the implementation or report, classify the issue as a finding, residual risk, unverified scope, or blocked status according to the supplied evidence.
