...
func hostReadOnlySearchPathPolicyAllowScenarios(repoRoot string) []hostReadOnlySearchScenario {
	...
	allow = append(allow,
		...
		hostReadOnlySearchScenario{name: "grep directories recurse long option", command: "grep", args: []string{"--directories=recurse", filepath.Join(repoRoot, "internal"), "pattern"}},
		hostReadOnlySearchScenario{name: "grep directories recurse short attached option", command: "grep", args: []string{"-drecurse", filepath.Join(repoRoot, "internal"), "pattern"}},
...
func hostReadOnlySearchPathPolicyBlockedOutsideScenarios() []hostReadOnlySearchScenario {
	return []hostReadOnlySearchScenario{
		...
		{name: "grep directories recurse long option outside path", command: "grep", args: []string{"--directories=recurse", "/etc", "pattern"}},
		{name: "grep directories recurse short attached option outside path", command: "grep", args: []string{"-drecurse", "/etc", "pattern"}},
