...
func TestDecodeReviewSaturationCheckJSONAcceptsSaturatedCheck(t *testing.T) {
	...
	got, err := DecodeReviewSaturationCheckJSON(data, newNoProbeReviewProbePlanForTest(), newPlanAwareCleanReportForValidationTest())
	if err != nil {
...
func TestDecodeReviewSaturationCheckJSONRejectsUnknownFieldAndTrailingJSON(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := DecodeReviewSaturationCheckJSON([]byte(tt.input), newNoProbeReviewProbePlanForTest(), newPlanAwareCleanReportForValidationTest())
			if err == nil {
...
func TestValidateReviewSaturationCheckNeedsRevisionForMissingRisk(t *testing.T) {
	...
	if err := ValidateReviewSaturationCheck(check, newNoProbeReviewProbePlanForTest(), newPlanAwareCleanReportForValidationTest()); err != nil {
...
func TestValidateReviewSaturationCheckNeedsRevisionForAdditionalFindingCandidate(t *testing.T) {
	...
	if err := ValidateReviewSaturationCheck(check, newNoProbeReviewProbePlanForTest(), report); err != nil {
		t.Fatalf("ValidateReviewSaturationCheck() error = %v, want nil", err)
	}
}
...
func TestValidateReviewSaturationCheckRejectsInvalidStatusContracts(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ValidateReviewSaturationCheck(tt.check, newNoProbeReviewProbePlanForTest(), newPlanAwareCleanReportForValidationTest())
			if err == nil {
