...
func newReviewProbePlanImpactSurfaceEvidenceIndex(surfaces []ReviewProbeImpactSurface) reviewProbePlanImpactSurfaceEvidenceIndex {
...
func validateReviewProbePlanMaterialPathCoverage(input ReviewEvidenceModelInput, index reviewProbePlanImpactSurfaceEvidenceIndex) error {
...
func reviewProbePlanEvidenceMaterialPaths(input ReviewEvidenceModelInput) []string {
	var paths []string
...
func validateReviewProbePlanInventoryCategoryCoverage(input ReviewEvidenceModelInput, index reviewProbePlanImpactSurfaceEvidenceIndex) error {
	untrackedPaths := reviewProbePlanEvidenceUntrackedPathSet(input)
	categories := []struct {
		name  string
		paths []string
...
func validateReviewProbePlanUntrackedCoverage(input ReviewEvidenceModelInput, plan ReviewProbePlan, index reviewProbePlanImpactSurfaceEvidenceIndex) error {
...
func validateReviewProbePlanGenericImpactCoverage(input ReviewEvidenceModelInput, index reviewProbePlanImpactSurfaceEvidenceIndex) error {
	if len(input.GenericImpact.Candidates) == 0 {
		return nil
	}
	candidatesByRole := make(map[string][]ReviewEvidenceGenericImpactCandidateInput)
	roles := make([]string, 0)
...
func reviewProbePlanEvidenceUntrackedPaths(input ReviewEvidenceModelInput) []string {
...
func reviewProbePlanEvidenceUntrackedPathSet(input ReviewEvidenceModelInput) map[string]struct{} {
...
func validateReviewProbePlanTruncationPressure(input ReviewEvidenceModelInput, plan ReviewProbePlan) error {
...
func validateReviewProbePlanGenericImpactTruncationPressure(input ReviewEvidenceModelInput, plan ReviewProbePlan) error {
...
func reviewEvidenceInputHasDiffContextOrSearchTruncation(input ReviewEvidenceModelInput) bool {
...
func validateReviewProbePlanNoProbeRequiresRelatedEvidence(input ReviewEvidenceModelInput, plan ReviewProbePlan) error {
...
func reviewProbePlanAllImpactSurfacesChecked(plan ReviewProbePlan) bool {
