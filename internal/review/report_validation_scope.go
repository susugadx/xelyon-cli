...
// ValidateReviewReportAgainstProbePlan は Pass2 report が Pass1 scope を閉じていることを検証する。
func ValidateReviewReportAgainstProbePlan(report ReviewReport, plan ReviewProbePlan, _ []ReviewProbeSummary) error {
...
func validateReviewReportScopeCoverageAgainstPlan(report ReviewReport, plan ReviewProbePlan) error {
	if report.ScopeCoverage == nil {
...
func validateReviewReportImpactSurfaceCoverageAgainstPlan(coverage *ReviewReportScopeCoverage, plan ReviewProbePlan) error {
...
func validateReviewReportCandidateRiskCoverageAgainstPlan(coverage *ReviewReportScopeCoverage, plan ReviewProbePlan) error {
