...
- A finding requires evidence for affected behavior and causal chain. Static code, schema, and control-flow evidence can satisfy this requirement; runtime reproduction strengthens confidence but is not required. Missing verification alone must be represented as unverified, residual_risk, or blocked coverage instead of a finding.
