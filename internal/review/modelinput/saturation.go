...
Missing verification alone is a coverage gap, not an additional finding candidate. Add or preserve findings only when supplied evidence establishes affected behavior and causal chain.
