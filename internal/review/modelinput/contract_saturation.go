...
- Missing verification alone is a coverage gap, not an additional finding candidate. Return an additional finding candidate only when supplied evidence establishes affected behavior and causal chain.
