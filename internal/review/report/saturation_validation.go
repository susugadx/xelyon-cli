...
func ValidateReviewSaturationCheck(check ReviewSaturationCheck, plan PlanScope, finalizedReport ReviewReport) error {
...
func indexReviewSaturationImpactSurfaceIDs(plan PlanScope) map[string]struct{} {
...
func indexReviewSaturationCandidateRiskIDs(plan PlanScope) map[string]struct{} {
