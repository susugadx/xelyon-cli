...
- "external_doc" refs require "doc_id", "snippet_id", "url", "fetched_at", and snippet "content_hash" copied from fetched external_docs snippets. Raw web search results are discovery-only and must not be cited as evidence refs. Fetched external_doc snippets are citation-capable evidence, but are not automatically official documentation or confirmed external specs unless source domain, title, and content clearly support that claim.
...
- "external_doc" refs require "doc_id", "snippet_id", "url", "fetched_at", and snippet "content_hash" copied from a fetched external_docs snippet in Evidence Markdown. Do not cite raw web search results; fetched external_doc snippets are citation-capable evidence, but are not automatically official documentation or confirmed external specs unless source domain, title, and content clearly support that claim.
