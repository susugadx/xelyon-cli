...
type reviewPromptReductionStats struct {
	report ReviewPromptReductionReport
}

func newReviewPromptReductionStats(mode ReviewPromptReductionMode) *reviewPromptReductionStats {
	return &reviewPromptReductionStats{
		report: ReviewPromptReductionReport{
...
func (s *reviewPromptReductionStats) record(classifier string, savedBytes, savedTokens int, applied bool) {
	if s == nil {
		return
	}
...
func (s *reviewPromptReductionStats) recordStateSummary(absorbedItems int) {
	if s == nil {
		return
	}
...
func (s *reviewPromptReductionStats) recordItem(item ReviewPromptReductionItem) {
	if s == nil {
		return
	}
	if item.Family != "" {
...
func (s *reviewPromptReductionStats) recordKeepReason(reason string) {
	if s == nil || reason == "" {
		return
	}
...
func (s *reviewPromptReductionStats) recordRawOutputLedger(ledger ReviewProbeRawOutputLedger) {
...
func (s *reviewPromptReductionStats) reportValue() ReviewPromptReductionReport {
	if s == nil {
