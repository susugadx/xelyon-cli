...
func (cs *configScreen) handleSliceInputKey(msg tea.KeyMsg) (configCommand, tea.Cmd) {
	switch {
...
func (cs *configScreen) beginSliceAdd() {
	cs.editSliceAdding = true
	cs.editSliceInput.SetValue("")
	cs.editSliceInput.Focus()
}

func (cs *configScreen) beginSliceItemEdit() {
...
func (cs *configScreen) deleteSelectedSliceItem() {
	if cs.editSliceIndex < 0 || cs.editSliceIndex >= len(cs.editSliceItems) {
		return
	}
...
func (cs *configScreen) finishSliceInput(apply bool) {
	if apply {
