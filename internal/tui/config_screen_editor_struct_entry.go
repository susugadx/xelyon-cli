...
func (cs *configScreen) handleStructEntryEdit(msg tea.KeyMsg) (configCommand, tea.Cmd) {
...
func (cs *configScreen) closeStructEntryEdit() {
	cs.editEntryActive = false
	cs.editEntryFields = nil
}

func (cs *configScreen) toggleSelectedStructEntryBool() {
...
func (cs *configScreen) beginStructEntryInputEdit(ef *structEntryField, format func(interface{}) string) {
...
func (cs *configScreen) beginStructEntrySliceEdit(ef *structEntryField) {
