...
func (cs *configScreen) handleBrowseKey(msg tea.KeyMsg, layout configLayout, providerConfigKey string) (configCommand, tea.Cmd) {
	s := msg.String()
...
func (cs *configScreen) beginFilter() {
	cs.filterMode = true
