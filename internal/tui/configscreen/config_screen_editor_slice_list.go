...
func (cs *Screen) handleFieldSliceListKey(msg tea.KeyMsg, field *config.ConfigField) (configCommand, tea.Cmd) {
	s := msg.String()
	switch {
...
func (cs *Screen) handleEntrySliceListKey(msg tea.KeyMsg) (configCommand, tea.Cmd) {
	s := msg.String()
	switch {
	case msg.Type == tea.KeyEsc:
...
func (cs *Screen) moveSliceEditIndex(delta int) {
...
func (cs *Screen) closeFieldSliceEdit(field *config.ConfigField) {
...
func (cs *Screen) closeEntrySliceEdit() {
