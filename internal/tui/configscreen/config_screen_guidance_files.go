...
func (cs *Screen) editingGuidanceFileChoices(path string) bool {
	return len(cs.editGuidanceChoices) > 0 && (path == agentInstructionProjectFilesPath || path == agentInstructionGlobalFilesPath)
}

func (cs *Screen) handleGuidanceFileChoiceKey(msg tea.KeyMsg, field *config.ConfigField) (configCommand, tea.Cmd) {
	s := msg.String()
	switch {
...
func (cs *Screen) moveGuidanceChoiceIndex(delta int) {
...
func (cs *Screen) toggleSelectedGuidanceChoice() {
...
func (cs *Screen) deleteSelectedCustomGuidanceChoice() {
	if cs.editGuidanceIndex < 0 || cs.editGuidanceIndex >= len(cs.editGuidanceChoices) {
		return
	}
...
func (cs *Screen) syncGuidanceChoicesForCurrentField() {
...
func (cs *Screen) renderGuidanceFileChoiceDetail(addLine func(string), field *config.ConfigField) {
