...
func (cs *Screen) spaceToggle(providerConfigKey string) {
...
func (cs *Screen) handleBrowseEnter(layout configLayout, providerConfigKey string) (configCommand, tea.Cmd) {
...
func (cs *Screen) startFieldEdit(field *config.ConfigField, targetPane configPane, providerConfigKey string) (configCommand, tea.Cmd) {
...
func (cs *Screen) toggleBoolField(field *config.ConfigField, providerConfigKey string) {
	current, _ := field.Current.(bool)
	cs.applyFieldValue(field.Path, !current, providerConfigKey)
}

func (cs *Screen) beginSelectEdit(field *config.ConfigField, targetPane configPane) {
...
func (cs *Screen) beginInputEdit(targetPane configPane, value string) {
...
func (cs *Screen) beginSliceEdit(targetPane configPane, field *config.ConfigField) {
...
func (cs *Screen) beginStructMapEdit(targetPane configPane, field *config.ConfigField) {
