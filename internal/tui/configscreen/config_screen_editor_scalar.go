...
func (cs *Screen) handleEditKey(msg tea.KeyMsg, providerConfigKey string) (configCommand, tea.Cmd) {
	switch cs.editMode {
	case editSelect:
...
func (cs *Screen) handleSelectEdit(msg tea.KeyMsg, providerConfigKey string) (configCommand, tea.Cmd) {
...
func (cs *Screen) handleInputEdit(msg tea.KeyMsg, providerConfigKey string) (configCommand, tea.Cmd) {
	field := cs.selectedField()
	if field == nil {
		cs.editMode = editNone
		return configCommandNone, nil
