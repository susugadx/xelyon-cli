...
var projectInstructionPrecedenceLines = []string{
	...
	"- Legacy xelyon.yaml rules/context are compatibility project config and are rendered separately from repository guidance.",
	"- Legacy xelyon.yaml rules remain mandatory project policy when present.",
