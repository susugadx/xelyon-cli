...
**プロバイダー診断**: `xelyon doctor azure --smoke` は `responses.store=false` の live Responses request で到達性に加え、response ID、usage、pricing catalog に基づく概算 cost を text / JSON に出力。
